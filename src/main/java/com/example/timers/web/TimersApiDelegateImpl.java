...
import com.example.timers.api.TimersApiDelegate;
import com.example.timers.domain.timer.Timer;
import com.example.timers.model.CreateTimerRequestDto;
import com.example.timers.model.TimerDto;
...
public class TimersApiDelegateImpl implements TimersApiDelegate {
    ...
    @Override
    public ResponseEntity<TimerDto> getTemplateById(String id) {
    ...
    @Override
    public ResponseEntity<List<TimerDto>> listTemplates() {
